...
- config_name: inputs
  data_files:
  - split: train
    path: ["benchmark-dev-llama-small.h5", "config.json"]
- config_name: truths
  data_files:
  - split: train
    path: ["benchmark-dev-llama-small.h5", "config.json"]
...
tira-cli dataset-submission --path task-2-spot-check --task sisap-2026 --split train --dry-run
